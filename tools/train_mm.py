...
# from val_mm_ori import evaluate
from val_mm import evaluate
from semseg.datasets import Mydata
...
def main(cfg, gpu, save_dir):
    ...
    traintransform = get_train_augmentation(train_cfg['IMAGE_SIZE'], seg_fill=0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../configs/rv_source_domain.yaml', help='Configuration file to use')
